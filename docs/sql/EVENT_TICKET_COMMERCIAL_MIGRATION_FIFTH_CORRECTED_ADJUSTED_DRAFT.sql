-- docs/sql/EVENT_TICKET_COMMERCIAL_MIGRATION_FIFTH_CORRECTED_ADJUSTED_DRAFT.sql
-- Version: v4.8.104-event-ticket-commercial-migration-fifth-corrected-adjusted-draft-safe
-- Base: v4.8.103-event-ticket-commercial-migration-fourth-corrected-adjusted-draft-structural-review-safe
--
...
-- - eight v4.8.103 blockers are corrected in this separate seventh draft.
...
begin
  raise exception using
    errcode = 'P0001',
    message = 'MHIDAS_PROTECTED_DRAFT_V4_8_104',
...
-- =============================================================================
-- 49. EXPLICIT PROTECTED-DRAFT DECISION
-- =============================================================================

-- draft_decision=fifth_corrected_adjusted_draft_ready_for_sixth_structural_review
-- parsed_postgres_statement_count=395
-- corrected_adjustments=8
...
-- v4_8_102_fourth_corrected_sql_changed=False
