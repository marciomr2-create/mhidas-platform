-- docs/sql/EVENT_TICKET_COMMERCIAL_MIGRATION_CORRECTED_ADJUSTED_DRAFT.sql
-- Version: v4.8.93-event-ticket-commercial-migration-corrected-adjusted-draft-safe
-- Base: v4.8.92-event-ticket-commercial-adjusted-draft-second-adjustment-plan-safe
--
...
-- - seven v4.8.91 blockers are corrected in this separate draft.
...
begin
  raise exception using
    errcode = 'P0001',
    message = 'MHIDAS_PROTECTED_DRAFT_V4_8_93',
...
-- =============================================================================
-- 23. EXPLICIT PROTECTED-DRAFT DECISION
-- =============================================================================

-- draft_decision=corrected_adjusted_draft_ready_for_second_structural_review
-- original_adjustments_total=18
-- second_adjustments_total=7
-- second_adjustments_corrected=7
...
-- v4_8_90_adjusted_draft_changed=False
