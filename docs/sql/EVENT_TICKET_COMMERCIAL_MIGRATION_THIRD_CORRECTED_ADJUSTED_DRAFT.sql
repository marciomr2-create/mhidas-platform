-- docs/sql/EVENT_TICKET_COMMERCIAL_MIGRATION_THIRD_CORRECTED_ADJUSTED_DRAFT.sql
-- Version: v4.8.99-event-ticket-commercial-migration-third-corrected-adjusted-draft-safe
-- Base: v4.8.98-event-ticket-commercial-second-corrected-draft-fourth-adjustment-plan-safe
--
...
-- - nine v4.8.97 blockers are corrected in this separate fifth draft.
...
begin
  raise exception using
    errcode = 'P0001',
    message = 'MHIDAS_PROTECTED_DRAFT_V4_8_99',
...
-- =============================================================================
-- 31. EXPLICIT PROTECTED-DRAFT DECISION
-- =============================================================================

-- draft_decision=third_corrected_adjusted_draft_ready_for_fourth_structural_review
-- prior_adjustments_total=18
-- second_adjustments_total=7
-- fourth_adjustments_total=10
-- fifth_adjustments_total=9
-- fifth_adjustments_corrected=9
-- fifth_critical_corrections=6
-- fifth_high_corrections=3
...
-- v4_8_96_second_corrected_sql_changed=False
