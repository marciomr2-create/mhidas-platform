// src/app/dashboard/cards/[card_id]/club/edit/advanced/page.tsx
...
export default async function CardClubAdvancedEditPage({ params }: PageProps) {
  ...
  return (
    <main style={pageStyle()}>
      <header style={{ display: "grid", gap: 10 }}>
        <h1 style={{ fontWeight: 900, margin: 0 }}>Conteúdo completo do Perfil Clubber</h1>

        <p style={{ margin: 0, opacity: 0.82, lineHeight: 1.6, maxWidth: 760 }}>
          Gerencie artistas, eventos, streaming, caronas, encontros e demais conteúdos culturais.
        </p>
      </header>
      ...
      <section style={heroStyle()}>
        ...
        <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
          <Link href={`/dashboard/cards/${c.card_id}/club/edit`} style={buttonStyle()}>
            Voltar à edição principal
          </Link>
