// src/app/api/clubbers/connections/status/route.ts
...
export async function GET(request: NextRequest) {
  try {
    ...
    if (controlError) {
      console.error("[api/clubbers/connections/status] control select error:", controlError);
      return NextResponse.json(
    ...
    if (error) {
      console.error("[api/clubbers/connections/status] select error:", error);
      return NextResponse.json(
    ...
    console.error("[api/clubbers/connections/status] unexpected error:", error);
    return NextResponse.json(
